...
class ThemeRunner
  ...
  # <code>compile</code> will test just the compilation portion of liquid without any templates
  # 
  def compile
  ...
  # <code>run</code> is called to benchmark rendering and compiling at the same time
  #
  def run
  ...
  # <code>render</code> is called to benchmark just the render portion of liquid
  # 
  def render
